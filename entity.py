...
class Individuo:
    def __init__(self,x,y):
        ...
        self.radio_deteccion      =random.uniform(60,200)
        self.num_peligros         =random.randint(1,20)
...
def detectar_peligros(individuo, peligros):
    ...
    # Limitar número de peligros considerados
...
def spawn_peligro():
    ...
    speed=random.uniform(150,200)  # píxeles por segundo
...
def mutar(individuo,tasa=TASA_MUTACION):
